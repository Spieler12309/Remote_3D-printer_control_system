...
a = [20, 30, 40, 50, 60, 80, 100, 150, 200, 205, 203, 201, 198, 205, 180, 200]


# print(len(a))
# for i in a:
# 	print(str(temp_adctemp(i)) + ";")
#
# print("----------------")
# for i in a:
# 	print(str(adctemp_temp(temp_adctemp(i))) + ";")

print(adctemp_temp(1836))
print(temp_adctemp(30))