...
void MechanicsController::initMem() {
    ...
    settingsMaxSpeedZ 	    = v<uint32_t>(virtual_base, SETTINGS_MAX_SPEED_Z_BASE    );
    settingsMaxSpeedE0 	    = v<uint32_t>(virtual_base, SETTINGS_MAX_SPEED_E0_BASE   );
    settingsMaxSpeedE1 	    = v<uint32_t>(virtual_base, SETTINGS_MAX_SPEED_E1_BASE   );
