...
static const float maxspeed = 4000; // максимальная скорость
static const float maxspeed_z = 300; // максимальная скорость
static const float maxspeed_e = 200; // максимальная скорость
static const int frequency = 1000000; //тактовая частота двигателя
static const float default_speed = 2000; //скорость по умолчанию
...
*/
static const float DEFAULT_AXIS_STEPS_PER_UNIT[4] = {(200*16)/(2.0*20), (200*16)/(2.0*20), 200*8/2.0, 368.0}; //микрошагов/мм //92
...
// Homing speeds (mm/m)
static const float HOMING_FEEDRATE_XY = (20*60);//(50*60);
